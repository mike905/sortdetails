#сумма плюс разделение по файлам примечаниям
...
# Функция для получения названия файла на основе примечания
...
# Функция для сохранения данных по отдельным файлам на основе примечаний
